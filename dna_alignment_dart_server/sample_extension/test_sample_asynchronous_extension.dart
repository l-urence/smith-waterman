...
void main() {
  ...
  /* r.randomArray(121312, 10000).then((list_100) {
    r.randomArray(17123123, 20000).then((list_200) {
      for (var i = 0; i < 100; ++i) {
        print(list_100[i]);
  ...
  r.randomArray(17, 256000).then((List e) => print(e.first)/* e.forEach((e) => print(e))*/);
}
